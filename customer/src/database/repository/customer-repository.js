...
class CustomerRepository {
  ...
  async RemoveWishlist(customerId) {
    const CustomerRemovewishlist = await CustomerModel.findByIdAndUpdate({ _id: customerId });
    if (CustomerRemovewishlist) {
      const updateProfile = await CustomerModel.updateOne({_id:customerId},{$set:{wishlist:[]}});
